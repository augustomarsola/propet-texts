				...
				<div class="products-details-tabs">
					...
					<div class="tab-content" id="myTabContent">
						<div class="tab-pane fade show active" id="description" role="tabpanel">
							...
							<p><strong>INGREDIENTES:</strong> Água, coração bovino, batata doce, cenoura, arroz parboilizado, fígado bovino, ervilha, abóbora, folha de brócolis, óleo de canola, levedura de cerveja, semente de abóbora, alga nori, farinha de casca de ovo, fosfato bicálcico, sal light, magnésio quelado, ferro, quelado, sulfato de zinco, iodo quelado, manganês quelado, cobre quelado, vitamina B1, vitamina B2, niacinamida, pantetonato de cálcio, vitamina B6, cloreto de colina, ácido fólico, vitamina B12, vitamina A, vitamina D2, vitamina E</p>
							...
							<div class="row">
								...
								<div class="col-lg-5 col-md-12">
									...
									<ul class="leaders">
										...
										<li><span>Proteína bruta (mínimo)</span> <span>110g</span></li>
										<li><span>Matéria mineral (máximo)</span> <span>20g</span></li>
										<li><span>Extrato etéreo (mínimo)</span> <span>43g</span></li>
										<li><span>Fibra alimentar (máximo)</span> <span>15g</span></li>
